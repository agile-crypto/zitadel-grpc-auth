...
| Done | ZGA-04 | `Add admin API test seam` | Makes Zitadel admin calls replaceable in unit tests without changing public behavior. |
...
Current count: **4 of 10 commits complete; 6 remain**. Commit count is not an
